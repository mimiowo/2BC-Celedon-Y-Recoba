...
public class FrmSesion extends javax.swing.JFrame {
    ...
    public FrmSesion(Point p, LstUsuarios coleccion) {
        initComponents();
        this.setLocation(p);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 133, 150, 30));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 200, 150, 30));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        FrmCambiarContrasenia contrasenia = new FrmCambiarContrasenia(this.getLocation(), coleccion);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        FrmEliminarUsuario eliminarUsuario = new FrmEliminarUsuario(this.getLocation(), coleccion);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSesion(new Point(0, 0), new LstUsuarios()).setVisible(true);
            }
        });
    }
